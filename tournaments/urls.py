...
urlpatterns = [
    ...
    path('api/admin/tournaments/upload-questions/', TournamentQuestionUploadAPIView.as_view(), name='api_tournament_question_upload'),
    ...
    # --- User API Views ---
    path('api/tournaments/my/attempts/', views.UserTournamentAttemptListView.as_view(), name='api-user-attempts'),

    # --- Attempt Actions (Start & Submit) ---
    path('api/tournaments/attempts/start/', views.StartTournamentAttemptView.as_view(), name='api-start-attempt'),
    path('api/tournaments/attempts/submit/', views.SubmitTournamentAttemptView.as_view(), name='api-submit-attempt'),
